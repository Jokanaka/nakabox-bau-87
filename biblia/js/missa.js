...
const CONFITEOR = 'Confesso a Deus todo-poderoso e a vós, irmãos e irmãs, que pequei muitas vezes por pensamentos e palavras, atos e omissões, por minha culpa, minha culpa, minha tão grande culpa. E peço à Virgem Maria, aos anjos e santos e a vós, irmãos e irmãs, que rogueis por mim a Deus, nosso Senhor.';
...
export function buildMassSteps(lit, readings, texts) {
  ...
  add({ part: e, title: 'Orai, irmãos e irmãs', rubric: 'De pé.', dialog: [[P, 'Orai, irmãos e irmãs, para que o meu e vosso sacrifício seja aceito por Deus Pai todo-poderoso.'], [T, 'Receba o Senhor por tuas mãos este sacrifício, para glória do seu nome, para nosso bem e de toda a santa Igreja.'], [P, '(oração sobre as oferendas)'], [T, 'Amém.']] });
