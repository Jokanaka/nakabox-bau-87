...
const SHELL_CACHE = 'bc-v15-shell';   // casca do app: mude a cada versão do código
...
const SHELL = [
  ...
  './js/features.js', './js/liturgy.js', './js/audio.js', './js/cloudtts.js', './js/piper-worker.js', './js/missa.js', './js/voz.js',
